...
import styles from '../grifnoria/styles.module.css';
...
function Grifnoria() {
    ...
    const selectPerson = () => {
      axios.get('https://hp-api.onrender.com/api/characters/house/gryffindor').then((response) => {
